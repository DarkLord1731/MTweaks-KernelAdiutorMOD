 ...
 *
 */
package com.siddhant.oxygencontrol.utils.kernel.gpu;

import android.content.Context;

import com.siddhant.oxygencontrol.R;
import com.siddhant.oxygencontrol.fragments.ApplyOnBootFragment;
import com.siddhant.oxygencontrol.utils.Utils;
import com.siddhant.oxygencontrol.utils.root.Control;
...
public class GPUFreqExynos {
    ...
    private static final String MAX_EXYNOS7870_FREQ = "/sys/devices/11400000.mali/max_clock";
    private static final String MIN_EXYNOS7870_FREQ = "/sys/devices/11400000.mali/min_clock";
    private static final String CUR_EXYNOS7870_FREQ = "/sys/devices/11400000.mali/clock";
    private static final String AVAILABLE_EXYNOS7870_FREQS = "/sys/devices/11400000.mali/volt_table";
    private static final String AVAILABLE_EXYNOS7870_GOVERNORS = "/sys/devices/11400000.mali/dvfs_governor";
    private static final String TUNABLE_HIGHSPEED_EXYNOS7870_CLOCK = "/sys/devices/11400000.mali/highspeed_clock";
    private static final String TUNABLE_HIGHSPEED_EXYNOS7870_LOAD = "/sys/devices/11400000.mali/highspeed_load";
    private static final String TUNABLE_HIGHSPEED_EXYNOS7870_DELAY = "/sys/devices/11400000.mali/highspeed_delay";
    private static final String POWER_POLICY_EXYNOS7870 = "/sys/devices/11400000.mali/power_policy";
    private static final String UTILIZATION_EXYNOS7870 = "/sys/devices/11400000.mali/utilization";

    private static final String MAX_EXYNOS7885_FREQ = "/sys/devices/platform/11500000.mali/max_clock";
    private static final String MIN_EXYNOS7885_FREQ = "/sys/devices/platform/11500000.mali/min_clock";
    private static final String CUR_EXYNOS7885_FREQ = "/sys/devices/platform/11500000.mali/clock";
    private static final String AVAILABLE_EXYNOS7885_FREQS = "/sys/devices/platform/11500000.mali/volt_table";
    private static final String AVAILABLE_EXYNOS7885_GOVERNORS = "/sys/devices/platform/11500000.mali/dvfs_governor";
    private static final String TUNABLE_HIGHSPEED_EXYNOS7885_CLOCK = "/sys/devices/platform/11500000.mali/highspeed_clock";
    private static final String TUNABLE_HIGHSPEED_EXYNOS7885_LOAD = "/sys/devices/platform/11500000.mali/highspeed_load";
    private static final String TUNABLE_HIGHSPEED_EXYNOS7885_DELAY = "/sys/devices/platform/11500000.mali/highspeed_delay";
    private static final String POWER_POLICY_EXYNOS7885 = "/sys/devices/platform/11500000.mali/power_policy";
    private static final String UTILIZATION_EXYNOS7885 = "/sys/devices/platform/11500000.mali/utilization";
...

    {
        ...
        mAvailableVolts.put(AVAILABLE_EXYNOS7870_FREQS, 1000);
        mAvailableVolts.put(AVAILABLE_EXYNOS7885_FREQS, 1000);
        ...
        mCurrentFreqs.put(CUR_EXYNOS7870_FREQ, 1);
        mCurrentFreqs.put(CUR_EXYNOS7885_FREQ, 1);

        mMaxFreqs.add(MAX_S7_FREQ);
        mMaxFreqs.add(MAX_S8_FREQ);
        mMaxFreqs.add(MAX_S9_FREQ);
        mMaxFreqs.add(MAX_S10_FREQ);
        mMaxFreqs.add(MAX_EXYNOS7870_FREQ);
        mMaxFreqs.add(MAX_EXYNOS7885_FREQ);
        ...
        mMinFreqs.add(MIN_EXYNOS7870_FREQ);
        mMinFreqs.add(MIN_EXYNOS7885_FREQ);
        ...
        mAvailableFreqs.add(AVAILABLE_EXYNOS7870_FREQS);
        mAvailableFreqs.add(AVAILABLE_EXYNOS7885_FREQS);
        ...
        mScalingGovernors.add(AVAILABLE_EXYNOS7870_GOVERNORS);
        mScalingGovernors.add(AVAILABLE_EXYNOS7885_GOVERNORS);
        ...
        mTunableHighspeedClocks.put(TUNABLE_HIGHSPEED_EXYNOS7870_CLOCK, 1);
        mTunableHighspeedClocks.put(TUNABLE_HIGHSPEED_EXYNOS7885_CLOCK, 1);
        ...
        mTunableHighspeedLoads.put(TUNABLE_HIGHSPEED_EXYNOS7870_LOAD, 1);
        mTunableHighspeedLoads.put(TUNABLE_HIGHSPEED_EXYNOS7885_LOAD, 1);
        ...
        mTunableHighspeedDelays.put(TUNABLE_HIGHSPEED_EXYNOS7870_DELAY, 1);
        mTunableHighspeedDelays.put(TUNABLE_HIGHSPEED_EXYNOS7885_DELAY, 1);
        ...
        mPowerPolicies.put(POWER_POLICY_EXYNOS7870, 1);
        mPowerPolicies.put(POWER_POLICY_EXYNOS7885, 1);
        ...
        mUtilization.put(UTILIZATION_EXYNOS7870, 1);
        mUtilization.put(UTILIZATION_EXYNOS7885, 1);
    }
