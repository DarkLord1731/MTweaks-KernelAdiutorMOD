...
import com.siddhant.oxygencontrol.activities.BannerResizerActivity;
import com.siddhant.oxygencontrol.activities.MainActivity;
import com.siddhant.oxygencontrol.activities.NavigationActivity;
import com.siddhant.oxygencontrol.services.boot.ApplyOnBootService;
import com.siddhant.oxygencontrol.utils.AppSettings;
import com.siddhant.oxygencontrol.utils.Themes;
...
import com.siddhant.oxygencontrol.views.BorderCircleView;
    ...
    private void resetDataDialog(){
        ...
        alert.setPositiveButton(getString(R.string.ok), (dialog, id) -> {
            ...
            alert2.setNegativeButton(getString(R.string.cancel), (dialogInterface, i) -> {
                ...
                RootUtils.runCommand("pm clear com.siddhant.oxygencontrol");
            });
            alert2.setPositiveButton(getString(R.string.ok), (dialog1, id1) -> {
                RootUtils.runCommand("rm -rf /data/.mtweaks");
                RootUtils.runCommand("pm clear com.siddhant.oxygencontrol && reboot");
            });
            alert2.show();
        });
        alert.show();
